...
<head>
    ...
    <title>Public SuperMarket</title>
    ...
    <div class="wrapper" id="app">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="index3.html" class="brand-link">
                ...
                <span class="brand-text font-weight-light">Public SuperMarket</span>
            </a>
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="https://avatars.hsoubcdn.com/0939ef9ff74f5ed05070876cdec30f2a?s=256" class="img-circle elevation-2" alt="User Image">
                    </div>
                    <div class="info">
                        <a href="#" class="d-block">Mohammed Alamin</a>
                    </div>
                </div>
        ...
        <footer class="main-footer">
            ...
            <strong>Copyright &copy; 2014-2021 <a href="https://mohammed-alamin.netlify.app">Mohammed Alamin</a>.</strong> All rights reserved.
        </footer>
    </div>
